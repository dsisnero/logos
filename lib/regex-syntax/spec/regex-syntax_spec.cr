...
describe Regex::Syntax do
  ...
  it "has version constant" do
    Regex::Syntax::VERSION.should eq("0.5.0")
  end
  ...
  it "exposes direct HIR constructors and wrapper introspection like Rust" do
    dot = Regex::Syntax::Hir.dot(Regex::Syntax::Hir::Dot::AnyChar)
    dot.node.should be_a(Regex::Syntax::Hir::DotNode)
    dot.kind.should be_a(Regex::Syntax::Hir::DotNode)
    dot.into_kind.should be_a(Regex::Syntax::Hir::DotNode)
    ...
    fail_hir.node.as(Regex::Syntax::Hir::CharClass).intervals.should eq([] of Range(UInt8, UInt8))
  ...
  it "exposes direct HIR properties and look sets like Rust" do
    hir = Regex::Syntax.parse("(?m)^a|b")
    props = hir.properties

    props.should be_a(Regex::Syntax::Hir::Properties)
    props.minimum_len.should eq(1)
    props.maximum_len.should eq(1)
    props.explicit_captures_len.should eq(0)
    props.static_explicit_captures_len.should eq(0)
    props.utf8?.should be_true
    props.memory_usage.should be > 0

    hir.look_set.should be_a(Regex::Syntax::Hir::LookSet)
    hir.look_set_prefix.should be_a(Regex::Syntax::Hir::LookSet)
    hir.look_set_prefix_any.should be_a(Regex::Syntax::Hir::LookSet)
    hir.look_set_suffix.should be_a(Regex::Syntax::Hir::LookSet)
    hir.look_set_suffix_any.should be_a(Regex::Syntax::Hir::LookSet)
    hir.literal?.should be_false
    hir.alternation_literal?.should be_false
  end

  it "exposes look set constructors and subtraction helpers like Rust" do
    ...
    both = singleton.union(
      Regex::Syntax::Hir::LookSet.singleton(Regex::Syntax::Hir::Look::Kind::EndText)
    )
    removed = both.subtract(singleton)
    removed.contains(Regex::Syntax::Hir::Look::Kind::StartText).should be_false
    removed.contains(Regex::Syntax::Hir::Look::Kind::EndText).should be_true
  end

  it "exposes class helper operations like Rust" do
    bytes = Regex::Syntax::Hir::CharClass.new(false, [1_u8..3_u8])
    bytes.push(5_u8..5_u8)
    bytes.ranges.should eq([1_u8..3_u8, 5_u8..5_u8])
    bytes.union(Regex::Syntax::Hir::CharClass.new(false, [3_u8..6_u8]))
    bytes.ranges.should eq([1_u8..6_u8])
    bytes.difference(Regex::Syntax::Hir::CharClass.new(false, [2_u8..4_u8]))
    bytes.ranges.should eq([1_u8..1_u8, 5_u8..6_u8])
    bytes.symmetric_difference(Regex::Syntax::Hir::CharClass.new(false, [1_u8..1_u8]))
    bytes.ranges.should eq([5_u8..6_u8])
    bytes.to_unicode_class.should_not be_nil
    bytes.try_case_fold_simple.should be_a(Regex::Syntax::Hir::CharClass)

    unicode = Regex::Syntax::Hir::UnicodeClass.new(false, [0x61_u32..0x63_u32])
    unicode.push(0x65_u32..0x65_u32)
    unicode.ranges.should eq([0x61_u32..0x63_u32, 0x65_u32..0x65_u32])
    unicode.union(Regex::Syntax::Hir::UnicodeClass.new(false, [0x63_u32..0x66_u32]))
    unicode.ranges.should eq([0x61_u32..0x66_u32])
    unicode.difference(Regex::Syntax::Hir::UnicodeClass.new(false, [0x62_u32..0x64_u32]))
    unicode.ranges.should eq([0x61_u32..0x61_u32, 0x65_u32..0x66_u32])
    unicode.symmetric_difference(Regex::Syntax::Hir::UnicodeClass.new(false, [0x61_u32..0x61_u32]))
    unicode.ranges.should eq([0x65_u32..0x66_u32])
    unicode.to_byte_class.should_not be_nil
    unicode.try_case_fold_simple.should be_a(Regex::Syntax::Hir::UnicodeClass)
  end

  it "exposes repetition replacement helpers like Rust" do
    rep = Regex::Syntax::Hir::Repetition.new(
      Regex::Syntax::Hir::Literal.new("a".to_slice),
      1_u32,
      3_u32,
      greedy: false
    )
    replaced = rep.with(Regex::Syntax::Hir::Literal.new("b".to_slice))
    String.new(replaced.sub.as(Regex::Syntax::Hir::Literal).bytes).should eq("b")
    replaced.min.should eq(1_u32)
    replaced.max.should eq(3_u32)
  ...
  describe "look-set parity" do
    ...
    it "exposes mutating set_* aliases and iter like Rust" do
      set = Regex::Syntax::Hir::LookSet.empty
      set.set_insert(Regex::Syntax::Hir::Look::Kind::StartText)
      set.contains(Regex::Syntax::Hir::Look::Kind::StartText).should be_true

      other = Regex::Syntax::Hir::LookSet.empty
      other.set_insert(Regex::Syntax::Hir::Look::Kind::WordUnicode)
      set.set_union(other)
      set.contains_word_unicode.should be_true

      iterated = set.iter.to_a
      iterated.should contain(Regex::Syntax::Hir::Look::Kind::StartText)
      iterated.should contain(Regex::Syntax::Hir::Look::Kind::WordUnicode)

      set.set_intersect(Regex::Syntax::Hir::LookSet.singleton(Regex::Syntax::Hir::Look::Kind::StartText))
      set.to_a.should eq([Regex::Syntax::Hir::Look::Kind::StartText])

      set.set_remove(Regex::Syntax::Hir::Look::Kind::StartText)
      set.empty?.should be_true

      set.set_insert(Regex::Syntax::Hir::Look::Kind::StartLF)
      set.set_insert(Regex::Syntax::Hir::Look::Kind::WordAscii)
      set.set_subtract(Regex::Syntax::Hir::LookSet.singleton(Regex::Syntax::Hir::Look::Kind::StartLF))
      set.to_a.should eq([Regex::Syntax::Hir::Look::Kind::WordAscii])
    end
  end
  ...
  describe "hir class helper parity" do
    it "accepts vendored class aliases and wrapper constructors" do
      bytes = Regex::Syntax::Hir::ClassBytes.new([
        Regex::Syntax::Hir::ClassBytesRange.new(0x63_u8, 0x61_u8),
      ])
      bytes.ranges.should eq([0x61_u8..0x63_u8])
      bytes.is_ascii.should be_true
      bytes.push(Regex::Syntax::Hir::ClassBytesRange.new(0x7A_u8, 0x79_u8))
      bytes.ranges.should eq([0x61_u8..0x63_u8, 0x79_u8..0x7A_u8])

      unicode = Regex::Syntax::Hir::ClassUnicode.new([
        Regex::Syntax::Hir::ClassUnicodeRange.new('c'.ord.to_u32, 'a'.ord.to_u32),
      ])
      unicode.ranges.should eq([0x61_u32..0x63_u32])
      unicode.is_ascii.should be_true
      unicode.push(Regex::Syntax::Hir::ClassUnicodeRange.new('z'.ord.to_u32, 'y'.ord.to_u32))
      unicode.ranges.should eq([0x61_u32..0x63_u32, 0x79_u32..0x7A_u32])
    end
    ...
    it "exposes byte-class helpers like Rust" do
      ...
      singleton.is_ascii.should be_true
      ...
      non_ascii.is_ascii.should be_false
    ...
    it "exposes unicode-class helpers like Rust" do
      ...
      snowman.is_ascii.should be_false
    ...
    it "exposes class range wrappers and iterators like Rust" do
      byte_range = Regex::Syntax::Hir::ClassBytesRange.new(0x63_u8, 0x61_u8)
      byte_range.start.should eq(0x61_u8)
      byte_range.end.should eq(0x63_u8)
      byte_range.len.should eq(3)
      byte_range.to_range.should eq(0x61_u8..0x63_u8)

      unicode_range = Regex::Syntax::Hir::ClassUnicodeRange.new('z'.ord.to_u32, 'x'.ord.to_u32)
      unicode_range.start.should eq('x'.ord.to_u32)
      unicode_range.end.should eq('z'.ord.to_u32)
      unicode_range.len.should eq(3)
      unicode_range.to_range.should eq('x'.ord.to_u32..'z'.ord.to_u32)

      bytes = Regex::Syntax::Hir::CharClass.empty.push(0x61_u8..0x63_u8).iter.to_a
      bytes.size.should eq(1)
      bytes.first.start.should eq(0x61_u8)
      bytes.first.end.should eq(0x63_u8)

      unicode = Regex::Syntax::Hir::UnicodeClass.empty.push('a'.ord.to_u32..'c'.ord.to_u32).iter.to_a
      unicode.size.should eq(1)
      unicode.first.start.should eq('a'.ord.to_u32)
      unicode.first.end.should eq('c'.ord.to_u32)
    end

    it "exposes a class dispatcher wrapper like Rust" do
      byte_class = Regex::Syntax::Hir::Class.bytes(
        Regex::Syntax::Hir::CharClass.empty.push(0x41_u8..0x41_u8)
      )
      byte_class.kind.should eq(Regex::Syntax::Hir::Class::Kind::Bytes)
      byte_class.utf8?.should be_true
      byte_class.is_utf8.should be_true
      byte_class.minimum_len.should eq(1)
      byte_class.maximum_len.should eq(1)
      byte_class.literal.should eq(Bytes[0x41_u8])
      byte_class.case_fold_simple
      byte_class.bytes.should_not be_nil
      byte_class.bytes.as(Regex::Syntax::Hir::CharClass).ranges.should eq([0x41_u8..0x41_u8, 0x61_u8..0x61_u8])

      unicode_class = Regex::Syntax::Hir::Class.unicode(
        Regex::Syntax::Hir::UnicodeClass.empty.push('K'.ord.to_u32..'K'.ord.to_u32)
      )
      unicode_class.kind.should eq(Regex::Syntax::Hir::Class::Kind::Unicode)
      unicode_class.try_case_fold_simple
      unicode_class.unicode.should_not be_nil
      unicode_class.unicode.as(Regex::Syntax::Hir::UnicodeClass).ranges.should contain('k'.ord.to_u32..'k'.ord.to_u32)
      unicode_class.negate
      unicode_class.empty?.should be_false
      unicode_class.is_empty.should be_false
    end
  end
  ...
  describe "hir constructor parity" do
    ...
    it "accepts HIR wrapper overloads for literal, concat, and alternation" do
      literal = Regex::Syntax::Hir::Literal.new("ab".to_slice)
      Regex::Syntax::Hir::Hir.literal(literal).node.should be_a(Regex::Syntax::Hir::Literal)

      left = Regex::Syntax::Hir::Hir.literal("a".to_slice)
      right = Regex::Syntax::Hir::Hir.literal("b".to_slice)
      concat = Regex::Syntax::Hir::Hir.concat([left, right])
      concat.node.should be_a(Regex::Syntax::Hir::Literal)
      String.new(concat.node.as(Regex::Syntax::Hir::Literal).bytes).should eq("ab")

      alternation = Regex::Syntax::Hir::Hir.alternation([left, right])
      alternation.node.should be_a(Regex::Syntax::Hir::Alternation)
    end
    ...
    it "exposes kind introspection like Rust" do
      ...
      literal.kind.is_a?(Regex::Syntax::Hir::HirKind).should be_true
      literal.into_kind.should be_a(Regex::Syntax::Hir::Literal)
      literal.into_kind.is_a?(Regex::Syntax::Hir::HirKind).should be_true
    end
    ...
    it "exposes alternation-literal analysis with the vendored API name" do
      Regex::Syntax.parse("foo|bar").is_alternation_literal.should be_true
      Regex::Syntax.parse("a|b").is_alternation_literal.should be_false
    end
  end
