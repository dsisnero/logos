...
1. **Source fidelity**: Match Rust Logos behavior exactly
2. **Crystal idioms**: Follow Crystal conventions while preserving Rust semantics
3. **Zero-copy parsing**: Maintain Rust Logos' performance characteristics
...
- **Source languages**: Port from Rust (`vendor/regex-syntax/`) and Go (`vendor/go-colorful`)
- **Test porting**: Convert Rust/Go tests to Crystal specs with exact assertions
